...
class HHYolov3:
    ...
    def load(self, detector_config_file=None, detector_weights=None, **args):
        ...
        """
        self.detector = load_model(model_path=detector_config_file, weights_path=detector_weights)
...
if __name__ == '__main__':
    hhyolov3 = HHYolov3()
    hhyolov3.load('/home/huanghao/BaseDetectionAttack/detector_lab/PyTorch-YOLOv3/config/yolov3.cfg',
    '/home/huanghao/BaseDetectionAttack/detector_lab/PyTorch-YOLOv3/weights/yolov3.weights')
    input_img, img_cv2 = hhyolov3.prepare_img('/home/huanghao/BaseDetectionAttack/detector_lab/pytorch-YOLOv4/data/giraffe.jpg')
