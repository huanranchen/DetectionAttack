...
class HHYolov5:
    ...
    def load(self, weightfile, **args):
        w = str(weightfile[0] if isinstance(weightfile, list) else weightfile)
        self.detector = attempt_load(weightfile if isinstance(weightfile, list) else w, map_location=self.device, inplace=False)
    ...
    def detect_img_tensor_get_bbox_conf(self, img_tensor, img_cv2):
        # self.detector.eval()
...
#
# hhyolov5 = HHYolov5()
# hhyolov5.load('/home/huanghao/BaseDetectionAttack/detector_lab/HHDet/yolov5/yolov5/weight/yolov5s.pt')
# # hhyolov5.detect_cv2_show('./cat.jpeg')
# # print('123')
#
# im0s = cv2.imread('/home/huanghao/BaseDetectionAttack/detector_lab/HHDet/yolov4/Pytorch_YOLOv4/data/giraffe.jpg')
# # Padded resize
...
# box_array, confs = hhyolov5.detect_img_tensor_get_bbox_conf(img_tensor, im0s)
...
if __name__ == '__main__':
    hhyolov5 = HHYolov5()
    hhyolov5.load('/home/huanghao/BaseDetectionAttack/detector_lab/yolov5/weight/yolov5s.pt')
    hhyolov5.detect_cv2_show('/home/huanghao/BaseDetectionAttack/detector_lab/pytorch-YOLOv4/data/giraffe.jpg')

    im0s = cv2.imread('/home/huanghao/BaseDetectionAttack/detector_lab/pytorch-YOLOv4/data/giraffe.jpg')
    # Padded resize
    im = letterbox(im0s, hhyolov5.imgsz, stride=hhyolov5.stride, auto=True)[0]
    # Convert
    im = im.transpose((2, 0, 1))[::-1]  # HWC to CHW, BGR to RGB
