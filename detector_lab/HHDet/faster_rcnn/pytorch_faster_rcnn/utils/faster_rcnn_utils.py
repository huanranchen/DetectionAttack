...
from .roi_header_util import RoIHeads
from .rpn_utils import RPNHead, RegionProposalNetwork
from .transform_utils import GeneralizedRCNNTransform
...
class FasterRCNNBase(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        proposals, proposal_losses, obj_scores = self.rpn(images, features, targets)
