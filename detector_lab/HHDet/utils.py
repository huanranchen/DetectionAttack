...
def init_detector(detector_name):
    ...
    if detector_name == "YOLOV4":
        ...
        detector.load(cfg_file='./detector_lab/HHDet/yolov4/Pytorch_YOLOv4/cfg/yolov4.cfg',
                      model_weights='./detector_lab/HHDet/yolov4/Pytorch_YOLOv4/weight/yolov4.weights',
                      data_config_path='./detector_lab/HHDet/yolov4/Pytorch_YOLOv4')

    if detector_name == "YOLOV5":
        detector = HHYolov5(name="YOLOV5")
        detector.load(model_weights='./detector_lab/HHDet/yolov5/yolov5/weight/yolov5s.pt')

    if detector_name == "Military_FasterRCNN":
        detector = Military_FasterRCNN(name="Military_FasterRCNN")
        detector.load(
            model_weights='./detector_lab/HHDet/military_faster_rcnn/faster_rcnn/logs/ep300-loss0.701-val_loss1.057.pth',
    ...
    if detector_name == "Military_YOLOX":
        ...
        detector.load(
            model_weights='./detector_lab/HHDet/military_yolox/yolox/logs/ep1155-loss1.474-val_loss1.452.pth',
